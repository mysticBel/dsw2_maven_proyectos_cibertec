...
public class Hilos_Opciones extends Thread{
    ...
    private void mostrarNumerosPares() {
        ...
        System.out.println(" ");
        System.out.println("Terminó mostrar números pares menores a 20.");
    ...
    private void mostrarLetras() {
        ...
        System.out.println(" ");
        System.out.println("Terminó mostrar letras abecedario.");
    ...
    private void mostrarSerieMenor1000() {
        ...
        System.out.println(" ");
        System.out.println("Terminó la serie (n^2 + 1) menor a 1000.");
